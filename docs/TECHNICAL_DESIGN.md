...
正式公開先はGitHubリポジトリ`word-quest-jhs1`のGitHub Pagesです。公開URLは`https://ssshasimotosss-droid.github.io/word-quest-jhs1/`で、現在の検証済み配信コミットは`f9de4b5`です。HTTP 200と公開URLに対するChrome E2Eを確認済みです。
